		...
		<div class="d-flex">
			<div id="brand-img" class="d-flex align-items-center">
				<a class="navbar-brand" href="<?= Url::home() ?>">
					<img src="<?= Url::home() ?>img/brand1.png" alt="Logo" class="ps-2">
				</a>
			</div>
			<div class="d-flex flex-grow-1 flex-column">
				...
				<div id="nav-menu" class="d-flex justify-content-around">
					...
					<nav id="main-nav-menu" class="nav d-none d-lg-flex">
					  <a class="nav-link" aria-current="page" href="<?= Url::toRoute('pjax/index') ?>"><?= Yii::t('app', 'Home') ?></a>
					  <a class="nav-link" href="<?= Url::toRoute('pjax/about') ?>"><?= Yii::t('app', 'About') ?></a>
					  <a class="nav-link" href="<?= Url::toRoute('pjax/contact') ?>"><?= Yii::t('app', 'Contacts') ?></a>
					</nav>
