...
<div class="col-md-9">
    ...
    <?php else: ?>
        ...
        <p>
            Якщо ви маєте ділові запити або інші питання, будь ласка, заповніть наступну форму, щоб зв'язатися з нами.
              Дякуемо.
        </p>
            ...
            <div id="contact" class="col-10 col-md-6 col-lg-5 p-5 mx-auto mb-2">
                ...
                <?php $form = ActiveForm::begin(['id' => 'contact-form']); ?>
                    ...
                    <div class="form-group">
                        <?= Html::submitButton('Надiслати', ['class' => 'btn btn-primary', 'name' => 'contact-button']) ?>
                    </div>
